...
class DeepKernelLFMDataset(Dataset):
    ...
    def __init__(self, x, y, f=None, train_indices=None, n_train=0.6, n_training_instances=0.5):
        """
        Args:
        ...
        self.test_instance_indices = np.arange(n_training_instances, self.x_cond.shape[0])
